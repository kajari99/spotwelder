...
#include <Watchdog.h>
/*
 * spotwelder_keypad5x4-2022-04-09-es módosítva
 * 4x4 keypad version 2024.05.01.by Peter
 * 
 * Arduino pins:
 * A4 SDA_i2c_LCD
 * A5 SCL_i2c_LCD
...
#define MAXINDEX 3
#define INACTIVITY_TIMEOUT 50 //inactivity time set
...
{
  int error;
  pinMode(empty1, OUTPUT);
  pinMode(empty2, OUTPUT);
  pinMode(empty3, OUTPUT);
  pinMode(empty4, OUTPUT);
  pinMode(empty5, OUTPUT);
  pinMode(empty6, OUTPUT);
